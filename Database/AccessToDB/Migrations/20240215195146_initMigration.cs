...
namespace AccessToDB.Migrations
{
    ...
    public partial class initMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PublishKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PublishingHousesType = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MaxMinYear", "Year between 1900 and 2024");
                    table.ForeignKey(
                        name: "FK_Books_PublishingHouses_PublishingHousesType",
                        column: x => x.PublishingHousesType,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_PublishingHousesType",
                table: "Books",
                column: "PublishingHousesType");
